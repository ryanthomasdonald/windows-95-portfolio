...
//     newCard.innerHTML = `<img src="public/img/BJApp/images/${card.img}" height="192px" width="142px">`;
...
//     handObj.push(card);
//     let newCard = document.createElement("span");
//     newCard.innerHTML = `<img id="face-down" src="public/img/BJApp/images/beach-back-large.png" height="192px">`;
//     cardObj.append(newCard);
// }

// function dealDummyCard(cardObj){
//     let newCard = document.createElement("span");
//     newCard.innerHTML = `<img src="public/img/BJApp/images/beach-back-large.png" height="192px">`;
//     cardObj.append(newCard);
// }
...
//     finalText.innerHTML = `<span className="windows-font text-white" style="font-size:30px;">You win!</span>`;
//     message.append(finalText);
// }

// function printDealerWin(){
//     let finalText = document.createElement("span");
//     finalText.innerHTML = `<span className="windows-font text-white" style="font-size:30px;">The house wins!</span>`;
//     message.append(finalText);
// }

// function printPlayerBust(){
//     let finalText = document.createElement("span");
//     finalText.innerHTML = `<span className="windows-font text-white" style="font-size:30px;">You busted! The house wins!</span>`;
//     message.append(finalText);
// }

// function printDealerBust(){
//     let finalText = document.createElement("span");
//     finalText.innerHTML = `<span className="windows-font text-white" style="font-size:30px;">The house busted! You win!</span>`;
//     message.append(finalText);
// }

// function printTie(){
//     let finalText = document.createElement("span");
//     finalText.innerHTML = `<span className="windows-font text-white" style="font-size:30px;">It's a tie!</span>`;
//     message.append(finalText);
// }
...
// });
    return(
        ...
        <div className="table">
            ...
            <div className="flex-container" style="height:233px">
                <div style="width:300px"></div>
                <div className="message-box" style="width:600px; font-size:210px; text-align:center" id="message"></div>
                <div style="width:300px">
                <div id="p-wins" className="windows-font text-white" style="margin-left:192px; margin-top:98px; font-size:30px">0</div>
                <div id="d-wins" className="windows-font text-white" style="margin-left:192px; margin-top:42px; font-size:30px">0</div>
                </div>
            </div>
            <label style="margin-left:42px" className="player-name windows-font text-white">Dealer's Hand: 
                <span id="dealer-points" className="points"></span>
            </label>
            <div id="dealer-hand" style="height:225px; margin-left:32px" className="hand">
                <span>
                <img src="images/beach-back-large-double.png" height="192px" />
                </span>

            </div>
            </div>
            <div className="player">
            <label style="margin-left:42px" className="player-name windows-font text-white">Your Hand: 
                <span id="player-points" className="points"></span>
            </label>
            <div id="player-hand" style="height:225px; margin-left:32px;" className="hand">
                <span>
                <img src="images/beach-back-large-double.png" height="192px" />
                </span>
            ...
            <div className="buttons button-box" style="margin-left:42px; margin-top:12px;">
                <button id="new-hand-button" className="windows-font" type="button">New Hand</button>
                <button id="flip-button" className="windows-font" type="button">Flip Cards</button>
                <button id="hit-button" className="windows-font" type="button">Hit Me!</button>
                <button id="stand-button" className="windows-font" type="button">Stand</button>
            </div>
            <div className="score-box">
                <div id="player-total" className="text-white windows-font" style="margin-left:150px; font-size:30px; margin-top:16px">0</div>
            </div>
            <div className="score-box">
                <div id="dealer-total" className="text-white windows-font" style="margin-left:150px; font-size:30px; margin-top:16px">0</div>
            </div>
            </div>
        </div>
        <script src="./BJ95-script.js"></script>
        </>
    )
}
